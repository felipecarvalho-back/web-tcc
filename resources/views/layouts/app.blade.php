...
<body class="bg-background text-on-surface font-sans min-h-screen antialiased selection:bg-primary-container selection:text-white" x-data="{ mobileMenuOpen: false }">
    ...
    <!-- SIDEBAR PERSISTENTE (MENU LATERAL) -->
    <aside 
    ...
    >
        <div class="p-5 flex flex-col gap-6 overflow-y-auto">
            ...
            <div class="flex items-center justify-between">
                <a href="{{ route('portaria.monitoramento') }}" class="flex items-center gap-3 group">
            ...
            <!-- WebSocket Status (Laravel Reverb) -->
        ...
        <div class="p-4 border-t border-surface-container bg-surface-container-lowest flex flex-col gap-3">
            <div class="flex items-center gap-3 p-2 bg-surface-container-low rounded-xl border border-surface-container/60">
                ...
                <div class="flex flex-col min-w-0">
                    <span class="text-sm font-bold text-on-surface truncate">Guarda Silva</span>
                    <span class="text-xs text-on-surface-variant truncate">Guarita Principal • Operador</span>
                </div>
            </div>

            <a 
                href="{{ route('login') }}" 
                class="w-full flex items-center justify-center gap-2 py-2.5 px-3 bg-surface-container hover:bg-error-container hover:text-error text-on-surface font-semibold text-xs rounded-lg transition-colors"
            >
    ...
    <!-- ÁREA PRINCIPAL COM HEADER TOPO -->
    <div class="md:pl-72 flex flex-col min-h-screen">
        ...
        <header class="sticky top-0 z-30 h-16 bg-surface/90 backdrop-blur-md border-b border-surface-container flex items-center justify-between px-4 sm:px-8 no-print">
            <div class="flex items-center gap-3">
                ...
                <div class="hidden sm:flex items-center gap-2 text-on-surface-variant text-xs font-semibold">
                    <span class="material-symbols-outlined text-[18px] text-primary">domain</span>
                    <span>Centro Paula Souza • Faculdade de Tecnologia (FATEC)</span>
                </div>
            </div>
